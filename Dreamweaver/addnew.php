...
<form action="<?php echo $editFormAction; ?>" method="POST" name="addnote" id="addnote">
	Заголовок:<input name="title" type="text" required="required" id="title"  size="20"><br>
	Содержание:<input name="article" type="text" required="required" id="article" size="55">
	<input name="created" type="hidden" id="created" value="<?php echo date("Y-m-d");?>">
	<input type="submit">
